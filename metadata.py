...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/Users/dmitryleibin/PycharmProjects/DL_Project/mnist_data',
                        help='Directory for storing input data')
    parser.add_argument('--log_dir', type=str, default='/Users/dmitryleibin/PycharmProjects/DL_Project/mnist-tensorboard-embeddings/logs',
